...
input_file  = "Advanced_maths.json"
output_file = "Advanced_maths_results.json"

def tree_of_thought_prompt(q):
    question = q.get("question", "")
    choices  = q.get("options") or q.get("choices") or {}
    p  = (
        "You are an expert SAT Advanced Maths tutor.\n"
...
def evaluate_question(q, model):
    ...
    return pred, (pred.lower() == str(corr).lower())
